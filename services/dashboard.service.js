...
var DashboardService = (function() {
  function _getCustomersCount(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/customers/count/" + companyId,
  ...
  function _getCustomersCreatedThisMonth(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/customers/thisMonth/" + companyId,
        function(err, response, body) {
          if (err) {
            reject(err);
          }
  ...
  function _getServicesCount(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/services/count/" + companyId,
        function(err, response, body) {
          if (err) {
            reject(err);
          }
  ...
  function _getTicketsThisMonth(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/tickets/thisMonth/" + companyId,
        function(err, response, body) {
          if (err) {
            reject(err);
          }
  ...
  function _getNextTickets(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/tickets/nextTickets/" + companyId,
        function(err, response, body) {
          if (err) {
            reject(err);
          }
  ...
  function _getTicketsMonthGoal(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/tickets/monthGoal/" + companyId,
        function(err, response, body) {
          if (err) {
            reject(err);
          }
  ...
  function _getCustomersMonthGoal(companyId) {
    return new Promise(function(resolve, reject) {
      request.get(
        process.env.API_URL + "/dashboard/customers/monthGoal/" + companyId,
        function(err, response, body) {
          if (err) {
            reject(err);
          }
